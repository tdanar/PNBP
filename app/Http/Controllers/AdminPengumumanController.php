<?php namespace App\Http\Controllers;
	...
	class AdminPengumumanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
            ...
            $this->label_add_button    = "Tambah Pengumuman";
            ...
            $this->col[] = ["label"=>"Link","name"=>"link", "callback"=>function($row){
                return '<center><a href="'.$row->link.'">'.$row->link.'</a></center>';
            }];
			...
			$this->form = [];
			$this->form[] = ['label'=>'User','name'=>'id_user','type'=>'hidden','validation'=>'required','width'=>'col-sm-10','value' => CRUDBooster::myId()];
			$this->form[] = ['label'=>'Pengumuman','name'=>'pengumuman','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Link','name'=>'link','type'=>'text','validation'=>'url','width'=>'col-sm-10','placeholder'=>'Mohon masukkan URL yang benar'];
			...
			//$this->form[] = ["label"=>"Pengumuman","name"=>"pengumuman","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
