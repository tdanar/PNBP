<?php namespace App\Http\Controllers;
	...
	class AdminPeraturanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Pembuat','name'=>'id_user','type'=>'hidden','width'=>'col-sm-10','value' => CRUDBooster::myId()];
			$this->form[] = ['label'=>'Judul','name'=>'judul','type'=>'textarea','validation'=>'required|min:3|max:225','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Uraian','name'=>'uraian','type'=>'textarea','validation'=>'max:500','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Link','name'=>'link','type'=>'text','validation'=>'required|max:300|url','width'=>'col-sm-10'];
