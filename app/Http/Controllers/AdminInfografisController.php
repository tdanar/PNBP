<?php namespace App\Http\Controllers;
	...
	class AdminInfografisController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {
	    	# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->table 			   = "t_infografis";
            ...
            $this->label_add_button    = "Tambah Infografis";
			...
			$this->col[] = ["label"=>"Preview","name"=>"cover","image"=>true];
