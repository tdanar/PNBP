...
<script type="text/javascript">
    ...
    po.src = '//localhost:8080/index.php/idn/chat/getstatus/(click)/internal/(position)/bottom_right/(ma)/br/(hide_offline)/true/(top)/350/(units)/pixels/(leaveamessage)/true?r='+referrer+'&l='+location;
