...
@section("content")
    ...
    <ul class="nav nav-tabs">
        @if($id)
            <li role="presentation" class="active"><a href="{{Route('AdminLapAwasControllerGetStep1',['id'=>$id])}}"><i class='fa fa-info'></i> Tahap 1 - Identitas Laporan</a></li>
            <li role="presentation"><a href="{{Route('AdminLapAwasControllerGetStep2',['id'=>$id])}}"><i class='fa fa-search'></i> Tahap 2 - Input Temuan</a></li>
            <li role="presentation"><a href="{{Route('AdminLapAwasControllerGetStep3',['id'=>$id])}}"><i class='fa fa-tasks'></i> Tahap 3 - Input Rekomendasi</a>
            </li>
        @else
            <li role="presentation" class="active"><a href="#"><i class='fa fa-info'></i> Tahap 1 - Identitas Laporan</a></li>
            <li role="presentation"><a href="#"><i class='fa fa-search'></i> Tahap 2 - Input Temuan</a></li>
            <li role="presentation"><a href="#"><i class='fa fa-tasks'></i> Tahap 3 - Input Rekomendasi</a></li>
        @endif
    </ul>

    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">Identitas Laporan</h3>
        </div>
        <div class="box-body">
            <form method="post" action="{{Route('AdminLapAwasControllerPostStep2')}}">
        ...
        <div class="box-footer">
            ...
            <div class='pull-right'>
                <a class='btn btn-default' href='{{Route("AdminLapAwasControllerGetIndex")}}'> {{trans('crudbooster.button_back')}}</a>
