                ...
                <div class="info-header">
                    <div class="container">
                        ...
                        <div class="right-top">
                            ...
                            Selamat datang, <a href="\ma\users\profile">{{CRUDBooster::myName()}} <img src="{{CRUDBooster::myPhoto()}}" class="user-image" alt="User Image"></a> | <a href="\ma">Member Area</a> | <a href="\ma\logout">LOGOUT</a>
                            @else
