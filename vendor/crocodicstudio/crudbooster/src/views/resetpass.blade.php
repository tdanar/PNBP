...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <p class="login-box-msg">Silahkan masukkan password baru di bawah ini.</p>
        <form action="{{ route('postResetPass') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input type="password" class="form-control" name='password' required placeholder="Masukkan password baru"/>
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" class="form-control" name='password_confirmation' aria-label="konfirmasi password" required placeholder="Masukkan kembali password baru"/>
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <center>
